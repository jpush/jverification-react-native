...
参考：[App.tsx](https://github.com/jpush/jverification-react-native/blob/dev/AwesomeProject/App.tsx)

## 4. API
+ API详细说明：[API详细说明.md](https://github.com/jpush/jverification-react-native/blob/dev/API.md) 
